...
public class Almanac : MonoBehaviour
{
    ...
    private string[] plantDescriptions = new string[]
    {
        ...
        "Destroys a grave",
        "Hypnotizes the zombie that eats it, making it fight for you",
    ...
    private string[] plantNotes = new string[]
    {
        ...
        "Hopefully the price cut and Giga-Football zombies makes this finally not suck. Also this wasn't as hard to code as you'd think",
        ...
        "I really like what Brutal Mode did where it attacks in a cross. Maybe I should do that...",
        ...
        "I genuinely can't think of a single way to make it not useless besides making it like Reflourished's Maypop Mechanic. But even then I don't care enough to do that",
        ...
        "Would you believe me if I said this thing was harder to code than Hypnoshroom",
        "See Peashooter",
