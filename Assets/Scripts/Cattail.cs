...
public class Cattail : Plant
{
    ...
    protected override Zombie LookInRange(int row)
    {
        ...
        RaycastHit2D[] hits = Physics2D.BoxCastAll(origin, new Vector2(0.1f, ZombieSpawner.Instance.lanes * Tile.TILE_DISTANCE.y * 2), 0, Vector2.right, Tile.TILE_DISTANCE.x * 11, LayerMask.GetMask("Zombie"));
